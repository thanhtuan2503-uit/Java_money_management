...
public class TransactionDynamicFragmentAdapter extends RecyclerView.Adapter<TransactionDynamicFragmentAdapter.ViewHolder> {

    private List<TransactionDynamicFragmentModel> Types;
    private Context Context;
    private SharedPreferences sharedpreferences;

    public TransactionDynamicFragmentAdapter(ArrayList<TransactionDynamicFragmentModel> items, Context context) {
        this.Types = items;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TransactionDynamicFragmentModel type = Types.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btnItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editor.commit();
                    //((TransactionDynamicFragmentModel)Context).Back2Activity();
                }
            });
        }
    }
